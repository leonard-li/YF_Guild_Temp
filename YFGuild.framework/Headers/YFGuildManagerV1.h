...
@protocol YFGuildManagerV1Delegate <NSObject>
...
@interface YFGuildManagerV1 : NSObject

/// 单例
@property (class, nonatomic, readonly) YFGuildManagerV1 *sharedManager;
/// 公会信息
@property (strong, nonatomic, readonly) YFGuildInfo *guildInfo;
/// 设置监听
@property (weak, nonatomic) id<YFGuildManagerV1Delegate> delegate;
/// 当前玩家是否有公会
