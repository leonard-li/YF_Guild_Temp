...
@property (copy, nonatomic) NSString *appKey; // 业务标识
@property (assign, nonatomic) uint32_t platform; // 平台
...
// 兼容1.0版本的属性
@property (assign, nonatomic) uint64_t timestamp; // 创建时间(V1时间戳)

+ (instancetype)messageWithInfo:(Message *)info;
